...
def initialize_mcp_server():
    """
    Initialize the knowledge-mcp server with Supabase configuration.
    ...
    # Initialize Supabase configuration (same as main())
    knowledge_server.SUPABASE_URL = require_env("SUPABASE_URL")
    knowledge_server.SUPABASE_KEY = require_env("SUPABASE_KEY")
    knowledge_server.supabase = get_supabase_client(
        knowledge_server.SUPABASE_URL,
        knowledge_server.SUPABASE_KEY
    )

    logger.info(f"Initialized Supabase connection to {knowledge_server.SUPABASE_URL}")
